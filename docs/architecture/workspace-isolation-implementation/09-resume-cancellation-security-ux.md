# Workspace Isolation Implementation: Resume, Cancellation, Security, Performance, and UX

Developer-facing implementation guide for the Experimental workspace isolation implementation described by
[ADR 0016](../adr/0016-node-scoped-git-workspace-isolation.md), which is the source
