...
from orchestrator_cli.core.review_contract import REVIEW_RESPONSE_INSTRUCTION
...
EXECUTOR_CANONICAL_OUTPUT_INSTRUCTION = (
    ...
    "Do not rely on editing prior .orchestrator artifacts or redirecting review to "
    "another round file.\n"
