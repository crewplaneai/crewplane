...
from orchestrator_cli.architecture.contracts import InvocationWorkspaceContext
...
from orchestrator_cli.observability.events.payloads import WorkspaceEventPayload
