...
WORKSPACE_GIT_DETERMINISTIC_COMMIT_ENVIRONMENT = (
    ("GIT_AUTHOR_NAME", "orchestrator-cli"),
    ("GIT_AUTHOR_EMAIL", "orchestrator-cli@example.invalid"),
    ("GIT_AUTHOR_DATE", "2000-01-01T00:00:00+0000"),
    ("GIT_COMMITTER_NAME", "orchestrator-cli"),
    ("GIT_COMMITTER_EMAIL", "orchestrator-cli@example.invalid"),
