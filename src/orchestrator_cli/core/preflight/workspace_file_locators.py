...
from .models import WorkspaceFileLocator, WorkspaceFileSourceClass, WorkspaceFileTarget
from .references import TemplateReference
from .signatures import signature_for_payload
from .workspace_file_paths import (
...
from .workspace_git_file_reads import (
...
def workspace_file_path_record(
    ...
    if is_reserved_workspace_path(project_relative):
        append_workspace_file_error(
            ...
            node.id,
            raw_path,
            "Workspace file tokens cannot read reserved .orchestrator runtime roots.",
        )
        return None
