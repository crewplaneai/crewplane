        ...
        workflow = WorkflowPlan(
            ...
            nodes=[
                ...
                WorkflowNode(
                    id="left",
                    mode="parallel",
                    prompt_segments=[PromptSegment(role="shared", content="left")],
                    needs=["root"],
                    providers=[provider("p")],
                ),
                WorkflowNode(
                    id="right",
                    mode="parallel",
                    prompt_segments=[PromptSegment(role="shared", content="right")],
                    needs=["root"],
                    providers=[provider("p")],
                ),
                WorkflowNode(
        ...
        workflow = WorkflowPlan(
            ...
            nodes=[
                WorkflowNode(
                    id="root.1",
                    mode="parallel",
                    prompt_segments=[PromptSegment(role="shared", content="1")],
                    providers=[provider("p")],
                ),
                WorkflowNode(
                    id="root.2",
                    mode="parallel",
                    prompt_segments=[PromptSegment(role="shared", content="2")],
                    providers=[provider("p")],
                ),
                WorkflowNode(
                    id="root.3",
                    mode="parallel",
                    prompt_segments=[PromptSegment(role="shared", content="3")],
                    providers=[provider("p")],
                ),
                WorkflowNode(
                    id="merge.1.3",
        ...
        workflow = WorkflowPlan(
            ...
            nodes=[
                ...
                WorkflowNode(
                    id="a.done",
                    mode="sequential",
                    prompt_segments=[PromptSegment(role="shared", content="done a")],
                    needs=["a"],
                    providers=[ProviderSpec(provider="p", role="executor")],
                ),
                WorkflowNode(
                    id="b.done",
                    mode="sequential",
                    prompt_segments=[PromptSegment(role="shared", content="done b")],
                    needs=["b"],
                    providers=[ProviderSpec(provider="p", role="executor")],
                ),
            ],
        ...
        workflow = WorkflowPlan(
            ...
            nodes=[
                ...
                WorkflowNode(
                    id="summary.final",
                    mode="sequential",
                    prompt_segments=[PromptSegment(role="shared", content="summary")],
                    needs=["auth.review"],
                    providers=[ProviderSpec(provider="p", role="executor")],
                ),
            ],
