...
def test_verify_source_commit_available_fetches_chained_bundles_without_bundle_verify(
    tmp_path: Path,
    ...
    monkeypatch.setattr(GitCommand, "run", reject_bundle_verify)
